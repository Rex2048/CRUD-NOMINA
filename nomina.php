...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="text-info m-0">Registros guardados</h3>
        <div>
            <a href="pdfNomina.php" class="btn btn-danger fw-bold shadow me-2" target="_blank">
                Generar PDF
            </a>
            <a href="index.php" class="btn btn-success fw-bold shadow" role="button">
                Agregar empleado
            </a>
        </div>
    </div>
